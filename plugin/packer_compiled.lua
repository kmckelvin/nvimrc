...
_G.packer_plugins = {
  ...
  nerdtree = {
    loaded = true,
    path = "/Users/kevin/.local/share/nvim/site/pack/packer/start/nerdtree",
  ...
  ["nvim-code-action-menu"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/Users/kevin/.local/share/nvim/site/pack/packer/opt/nvim-code-action-menu",
  ...
  ["vim-endwise"] = {
    loaded = true,
    path = "/Users/kevin/.local/share/nvim/site/pack/packer/start/vim-endwise",
